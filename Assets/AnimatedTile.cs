...
namespace UnityEngine.Tilemaps
{
	...
	public class AnimatedTile : TileBase
	{
		...
		public override void GetTileData(Vector3Int location, ITilemap tileMap, ref TileData tileData)
		{
			...
			{
				tileData.sprite = m_AnimatedSprites[RandomStartTime ? GetRandomFrame() : 0];
		...
		public override bool GetTileAnimationData(Vector3Int location, ITilemap tileMap, ref TileAnimationData tileAnimationData)
		{
			if (m_AnimatedSprites.Length > 0)
			{
				...
				tileAnimationData.animationStartTime = RandomStartTime ? GetRandomFrame() * tileAnimationData.animationSpeed : 0;
				return true;
			}
			return false;
		}
		...
		{
			return Random.Range(0, m_AnimatedSprites.Length);
		}
	}
